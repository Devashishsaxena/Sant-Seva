        ...
        <React.Fragment>
            <Carousel fade interval={null} style={{opacity: "0.6"}}>
                    ...
                    <Carousel.Caption>
                            ...
                            <h6 className='d-flex justify-content-start align-items-start mt-5'>Schedule your company strategy right session now</h6>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img
            ...
            <Carousel activeIndex={index} onSelect={handleSelect} className='mt-3' fade variant='dark' style={{opacity:"0.6"}}  interval={null}>
                <Carousel.Item className='d-flex'>
                    <div className='col-2'>
                            <img src={temple1} style={{ width: '14rem' }} />
                        <div className='GreenEffect'>
                                <div><h5>Corpate Finance</h5></div>
                                <div>
                    ...
                    <div className='col-2'>
                        <img src={temple1} style={{ width: '14rem' }} />
                        <div className='GreenEffect'>
                                <div><h5>Corprate Restructuring</h5></div>
                                <div>
                                    <div className="d-flex justify-content-between">
                                        <h6>Okler</h6>
                                        <BsArrowRight size={40} />
                    ...
                    <div className='col-2'>
                            <img src={temple1} style={{ width: '14rem' }} />
                        <div className='GreenEffect'>
                                <div><h5>Economic Consulting</h5></div>
                                <div>
                                    <div className="d-flex justify-content-between">
                                        <h6>Okler</h6>
                                        <BsArrowRight size={40} />
                    ...
                    <div className='col-2'>
                            <img src={temple1} style={{ width: '14rem' }} />
                        <div className='GreenEffect'>
                                <div><h5>Litigation Consulting</h5></div>
                                <div>
                                    <div className="d-flex justify-content-between">
                                        <h6>Okler</h6>
                                        <BsArrowRight size={40} />
                    ...
                    <div className='col-2'>
                        ...
                        <div className='GreenEffect'>
                                <div><h5>Strategic Consulting</h5></div>
                                <div>
                                    <div className="d-flex justify-content-between">
                                        <h6>Okler</h6>
                                        <BsArrowRight size={40} />
                    ...
                    <div className='col-2'>
                        <img src={temple2} style={{ width: '14rem' }} />
                        <div className='GreenEffect'>
                                <div><h5>Brand Consulting</h5></div>
                                <div>
                                    <div className="d-flex justify-content-between">
                                        <h6>Okler</h6>
                                        <BsArrowRight size={40} />
